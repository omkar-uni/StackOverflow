            ...
            <div className='auth-container-2'>
                ...
                <form>
                    ...
                    </label>
                    {
                        isSignup && (
                            <label htmlFor="check">
                                <input type="checkbox" id='check' style={{width:"13px"}} />
                                <p style={{ fontSize: "13px" }}>Opt-in to receive occasional,<br />product updates, user research invitations,<br />company annoucement, and digests.</p>
                            </label>
                        )
                    }
